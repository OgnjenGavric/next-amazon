...
export const metadata: Metadata = {
  title: process.env.NEXT_PUBLIC_APP_NAME || 'FreeJack Shop',
  description:
    process.env.NEXT_PUBLIC_APP_DESC ||
    'FreeJack Shop, Nextjs, Server components, Next auth, daisyui, zustand',
}
...
export default async function Home() {
  ...
  return (
    <>
      <div className="w-full carousel rounded-box mt-4 min-h-[280px]">
